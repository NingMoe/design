            ...
            <div class="jarviswidget jarviswidget-color-pink jarviswidget-sortable" id="wid-id-0"
                ...
                <div role="content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="studentAccount" placeholder="学生学号(模糊查询)"
                                               class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="studentName" placeholder="学生姓名(模糊查询)"
                                               class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-1">
                                    <div class="input-group-btn">
                                        <button id="searchStudent" class="btn btn-primary" type="button"><i
                                ...
                                <div class="col-lg-1">
                                    <div class="input-group-btn">
                                        <button id="addStudent" class="btn btn-primary" type="button"><i
                                                class="fa fa-plus"></i> 添加学生
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div id="pageTableDiv" class="widget-body no-padding">
                        <!-- Table -->
                        <jsp:include page="showStudentPage.jsp"/>
                    </div>
                </div>
            </div>
        </article>
...
<div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-front ui-dialog-buttons ui-draggable "
    ...
    <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix"><span id="ui-id-1"
            ...
            class="widget-header"><h4><i class="fa fa-plus"></i> 添加学生 </h4></div></span>
        ...
        <form>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label>学生姓名</label>
                    <input type="text" placeholder="请输入学生姓名..." id="add_name" class="form-control">
                </div>

                <div class="form-group">
                    <label>联系方式</label>
                    <input type="text" placeholder="请输入学生电话号码..." id="add_phone" class="form-control">
                </div>

                <div class="form-group">
                    <label>所在班级</label>
                    <input type="text" placeholder="请输入学生班级名称..." id="add_class" class="form-control">
                </div>
    ...
    <div class="ui-dialog-buttonpane ui-widget-content ui-helper-clearfix">
        <div class="ui-dialog-buttonset">
            ...
            <button id="add_student" type="button" class="btn btn-danger"><i class="fa fa-check"></i>&nbsp; 确认</button>
        </div>
    </div>
</div>
<div id="show_update">
...
<div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-front ui-dialog-buttons ui-draggable "
    ...
    <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix"><span id="ui-id-2"
                                                                                            class="ui-dialog-title"><div
            class="widget-header"><h4><i class="fa fa-pencil"></i> 修改学生 </h4></div></span>
    ...
    <div id="updatetab" class="ui-dialog-content ui-widget-content"
        ...
        <form>
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label>学生姓名</label>
                    <input type="text" placeholder="请输入学生姓名..." id="update_name" class="form-control">
                </div>

                <div class="form-group">
                    <label>学生密码</label>
                    <input type="text" placeholder="请输入学生密码..." id="update_password" class="form-control">
                </div>
    ...
    <div class="ui-dialog-buttonpane ui-widget-content ui-helper-clearfix">
        <div class="ui-dialog-buttonset">
            ...
            <button id="update_student" type="button" class="btn btn-warning"><i class="fa fa-check"></i>&nbsp; 提交
            </button>
        </div>
    </div>
    <input type="hidden" id="update_id"/>
</div>
<script src="${ctx}/js/showAllStudent.js"/>
