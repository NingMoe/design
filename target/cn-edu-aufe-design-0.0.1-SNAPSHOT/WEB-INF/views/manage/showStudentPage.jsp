...
<table width="100%"
    ...
    <tbody>
    <c:if test="${studentLs==null||studentLs.size()==0}">
        <tr role="row" class="even">
            <td colspan="9">没有数据</td>
        </tr>
    </c:if>
    <c:forEach items="${studentLs}" var="student" varStatus="status">
        <tr role="row" class="even">
            <td>${student.id}</td>
            <td>${student.name}</td>
