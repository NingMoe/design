            ...
            <div class="jarviswidget jarviswidget-color-pink jarviswidget-sortable" id="wid-id-0"
                ...
                <div role="content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-1">
                                    <div class="input-group-btn">
                                        <button id="studentSearch" class="btn btn-primary" type="button"><i class="fa fa-paw"></i> 立即搜索
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="pageTableDiv" class="widget-body no-padding">
                        <!-- Table -->
                        <jsp:include page="studentPageTable.jsp"/>
                    </div>
                </div>
            </div>
        </article>
...
<!-- end widget grid -->
<script src="${ctx}/js/studentPaper.js" />
</div>
