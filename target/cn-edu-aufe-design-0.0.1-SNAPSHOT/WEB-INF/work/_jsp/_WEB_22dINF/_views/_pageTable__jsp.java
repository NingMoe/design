...
public class _pageTable__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    _jsp_PageTag_2.setPage((cn.edu.aufe.guixiaorun.bean.Page) _caucho_expr_9.evalObject(_jsp_env));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("WEB-INF/views/pageTable.jsp"), 2811739910049669812L, false);
    _caucho_depends.add(depend);
  ...
  public void caucho_init(ServletConfig config)
  {
    try {
      ...
      _caucho_expr_4 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${paperItem.phone}");
      _caucho_expr_5 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${paperItem.academy}");
      ...
      _caucho_expr_9 = com.caucho.jsp.JspUtil.createExpr(pageContext.getELContext(), "${page}");
    } catch (Exception e) {
