    ...
    b.prototype = {
        constructor: b, initInput: function () {
            ...
            this.isSaving = !0, a.when(this.save(e)).done(a.proxy(function (a) {
                ...
                return b === !1 ? (this.error(!1), void this.showForm(!1)) : "string" == typeof b ? (this.error(b), void this.showForm()) : (b && "object" == typeof b && b.hasOwnProperty("newValue") && (d = b.newValue), this.error(!1), this.value = d, void this.$div.triggerHandler("save", {
                    newValue: d,
                    submitValue: e,
                    response: a
                }))
