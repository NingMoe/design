...
!function (a) {
    ...
    "undefined" != typeof ko && ko.bindingHandlers && !ko.bindingHandlers.multiselect && (ko.bindingHandlers.multiselect = {
        ...
        buildButton: function () {
            this.$button = a(this.templates.button).addClass(this.options.buttonClass), this.$select.prop("disabled") ? this.disable() : this.enable(), this.options.buttonWidth && this.$button.css({width: this.options.buttonWidth});
        ...
        buildDropdownOptions: function () {
            this.$select.children().each(a.proxy(function (b, c) {
                ...
                var c = a(b.target).prop("checked") || !1, d = a(b.target).val() == this.options.selectAllValue;
                ...
                var e = a(b.target).val(), f = this.getOptionByValue(e), g = a("option", this.$select).not(f), h = a("input", this.$container).not(a(b.target));
                ...
                if (!a('input[type="text"]', this.$container).is(":focus"))if (9 != b.keyCode && 27 != b.keyCode || !this.$container.hasClass("open")) {
        ...
        createOptionValue: function (b) {
            ...
            var c = a(b).attr("label") || a(b).html(), d = a(b).val(), e = this.options.multiple ? "checkbox" : "radio", f = a(this.templates.li);
            a("label", f).addClass(e), a("label", f).append('<input type="' + e + '" />');
            var g = a(b).prop("selected") || !1, h = a("input", f);
        ...
        createOptgroup: function (b) {
            var c = a(b).prop("label"), d = a(this.templates.liGroup);
                    ...
                    clearTimeout(this.searchTimeout), this.searchTimeout = this.asyncFunction(a.proxy(function () {
                        this.query != b.target.value && (this.query = b.target.value, a.each(a("li", this.$ul), a.proxy(function (b, c) {
                            ...
                            if (d != this.options.selectAllValue) {
                                var e = a("label", c).text(), d = a("input", c).val();
        ...
        select: function (b) {
            ...
            for (var c = 0; c < b.length; c++) {
                var d = b[c], e = this.getOptionByValue(d), f = this.getInputByValue(d);
        ...
        return this.each(function () {
            var e = a(this).data("multiselect"), f = "object" == typeof c && c;
