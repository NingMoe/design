    ...
    e.prototype = {
        _settings: function () {
            ...
            if (b._settings(), storage && b.o.localStorage) {
                ...
                }), storeSettingsObj = JSON.stringify({widget: c}), getKeySettings != storeSettingsObj && localStorage.setItem(keySettings, storeSettingsObj)
            }
            ...
            function c() {
                if (a("#jarviswidget-fullscreen-mode").length) {
                    var c = a(b).height(), e = a("#jarviswidget-fullscreen-mode").find(d.o.widgets).children("header").height();
            ...
            d._settings(), d.widget.on(clickEvent, ".jarviswidget-toggle-btn", function (b) {
                ...
                a.SmartMessageBox ? a.SmartMessageBox({
                    ...
                    content: "警告: 关闭这个模块有风险！",
                    buttons: "[否][是]"
                }, function (b) {
                    "是" == b && (d._runLoaderWidget(a(this)), a("#" + e).fadeOut(d.o.deleteSpeed, function () {
        ...
        return this.each(function () {
            var c = a(this), d = c.data(f), g = "object" == typeof b && b;
